...
Begin solving this task step by step."""
    ...
    # All tool execution now delegates to executor.py's real handler_map.
    # Dead fake methods (_execute_code, _read_file, _write_file, _web_search,
    # _fetch_url, _send_message, _spawn_agent, _memory_read, _memory_write)
    # removed in intelligence upgrade commit 946cc76.
